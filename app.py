...
# --- CUSTOM CSS (MIDNIGHT & GOLD UPDATE) ---
st.markdown("""
    <style>
    ...
    .logo-text { font-size: 48px; font-weight: 900; color: #c8a45e; margin: 0; letter-spacing: -1px; }
    .tagline { font-size: 14px; color: #888; font-style: italic; margin-top: 5px; }
    ...
    /* Buttons and Inputs */
    .stButton>button { border-color: #c8a45e33 !important; color: #c8a45e !important; }
    </style>
...
st.markdown("""
    <div class="brand-container">
        ...
        <div class="tagline">The definitive AI terminal for the Indian equity markets.</div>
    </div>
    """, unsafe_allow_html=True)
